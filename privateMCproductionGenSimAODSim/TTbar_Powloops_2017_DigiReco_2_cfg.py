...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:TTbar_Powloops_2017_DigiReco_step1.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:TTbar_Powloops_2017_DigiReco.root'),
